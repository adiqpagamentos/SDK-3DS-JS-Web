...
window.gateway_adiq_url = "https://ecommerce.adiq.io/v1/", window.jwtString = "", $.getScript("https://songbird.cardinalcommerce.com/cardinalcruise/v1/songbird.js", function(e, o, n) {
...
class Adiq3ds {
    ...
    ValidParams(e) {
        ...
        if ((o = o.substring(0, 6).replace(/[^\d]/, "")).length < 6) throw new CartaoInvalidoException
    }
    async Authorization3ds() {
        configureSongbird(this.cardNumberId, this.validateCallback), await getTokenAuthorization3ds().then(e => this.threeDsCode = e)
    }
    InitChallenge(e, o, n) {
